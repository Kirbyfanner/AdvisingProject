      ...
      <div id="form">
	    ...
	    <div class="field">
			...
			<?php
				...
				/* Shows criteria user searched for */
				...
				if(empty($times)){
					...
					if($row){
						...
						while($row = mysql_fetch_row($rsA)){
							...
							$toReplace = array("CMSC", "CMPE", "MENG", "CENG");
							$replacements = array("Computer Science", "Computer Engineering", "Mechanical Engineering", "Chemical Engineering");
							$allowedMajors = str_replace($toReplace, $replacements, $row[3]);
							

							$found = 	"<tr><td>". date('l, F d, Y g:i A', strtotime($row[1]))."</td>".
									"<td>". $advName."</td>". 
									"<td>". $allowedMajors . "</td></tr>".
